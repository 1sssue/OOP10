...
public:
    ...
    void printInfo() const override {
        ...
        std::cout << "Трикутник з вершинами (" << x1_ << ", " << y1_ << "), (" << x2_ << ", " << y2_
            << "), (" << x3_ << ", " << y3_ << ")" << std::endl;
    }
...
public:
    ...
    void printInfo() const override {
        SetConsoleCP(1251);
        SetConsoleOutputCP(1251);
        std::cout << "Трикутник зі сторонами " << a_ << ", " << b_ << ", " << c_ << std::endl;
    }
...
public:
    ...
    void printInfo() const override {
        SetConsoleCP(1251);
        SetConsoleOutputCP(1251);
        std::cout << "Трикутник з медіанами " << ma_ << ", " << mb_ << ", " << mc_ << std::endl;
    }
...
int main() {
    ...
    VertexTriangle vt(0, 0, 2, 0, 0, 3);
    vt.printInfo();
    std::cout << "Площа: " << vt.calculateArea() << std::endl;

    SideTriangle st(2, 3, 4);
    st.printInfo();
    std::cout << "Площа: " << st.calculateArea() << std::endl;

    MedianTriangle mt(1, 2, 4);
    mt.printInfo();
    std::cout << "Площа: " << st.calculateArea() << std::endl;

    RightTriangle rt(0, 0, 2, 0, 0, 3);
    rt.printInfo();
    std::cout << "Радіус вписаного кола: " << rt.calculateInscribedCircleRadius() << std::endl;
    std::cout << "Радіус описаного кола: " << rt.calculateCircumscribedCircleRadius() << std::endl;
